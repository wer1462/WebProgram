		...
		<div id="search">
			<div id="search-box-head">
				<div class="search-box-title">
					<p>
						시흥·안산의 <span>어떤 방</span>에서
					</p>
					<p>
						살고 싶으신가요<span class="search-box-title-question">?</span>
					</p>
				</div>
			</div>
		...
		<div id="favorite">
			<div id="favorite-box-head">
				<div class="favorite-box-title">
					<p>
						이번 주 <span>인기있는 인룸</span>을 한 눈에 <a>매주 월요일을 기준으로 업데이트 됩니다.</a>
					</p>
							...
							<div class="top5-box"
								...
								<div class="top5-box-body">
									<p class="top5-box-body-tag-room">
										<a>원룸</a><a>안산</a><a>관심999+</a>
									</p>
									<p class="top5-box-body-tag-price">
										<a>999/99</a>
									</p>
									<p class="top5-box-body-tag-info">
										<a>1층, 37m², 관리비 5만</a><br /> <a>세명에서도 충분히 사는 집</a>
									</p>
								</div>
							</div>
						</li>
